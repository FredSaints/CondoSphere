...
CondoSphere.API/Controllers/ExpensesController.cs
...
CondoSphere.Application/Interfaces/IExpenseRepository.cs
...
CondoSphere.Application/Mappings/FinancialsProfile.cs
...
CondoSphere.Application/Services/Financials/ExpenseService.cs
CondoSphere.Application/Services/Financials/IExpenseService.cs
...
CondoSphere.Core/DTOs/Account/EmailDto.cs
...
CondoSphere.Core/DTOs/Financials/CreateExpenseDto.cs
CondoSphere.Core/DTOs/Financials/ExpenseDto.cs
...
CondoSphere.Core/Entities/Financials/ExpenseAttachment.cs
...
CondoSphere.Core/Enums/TwoFactorMethod.cs
...
## File: CondoSphere.API/Controllers/ExpensesController.cs
```csharp
...
## File: CondoSphere.Application/Interfaces/IExpenseRepository.cs
```csharp
...
## File: CondoSphere.Application/Mappings/FinancialsProfile.cs
```csharp
using AutoMapper;
using CondoSphere.Core.DTOs.Financials;
using CondoSphere.Core.Entities.Financials;
...
## File: CondoSphere.Application/Services/Financials/ExpenseService.cs
```csharp
using AutoMapper;
using CondoSphere.Application.Interfaces;
using CondoSphere.Core.DTOs.Financials;
...
## File: CondoSphere.Application/Services/Financials/IExpenseService.cs
```csharp
using CondoSphere.Core.DTOs.Financials;
...
## File: CondoSphere.Core/DTOs/Account/EmailDto.cs
```csharp
using System;
using System.Collections.Generic;
using System.Linq;
...
## File: CondoSphere.Core/DTOs/Financials/CreateExpenseDto.cs
```csharp
using System.ComponentModel.DataAnnotations;
...
## File: CondoSphere.Core/DTOs/Financials/ExpenseDto.cs
```csharp
namespace CondoSphere.Core.DTOs.Financials
{
...
## File: CondoSphere.Core/Entities/Financials/ExpenseAttachment.cs
```csharp
using CondoSphere.Core;
using System.ComponentModel.DataAnnotations;
...
## File: CondoSphere.Infrastructure/Repositories/ExpenseRepository.cs
```csharp
using CondoSphere.Application.Interfaces;
using CondoSphere.Core.Entities.Financials;
...
@if (ViewData["Mensagem"] is string msg && !string.IsNullOrWhiteSpace(msg))
...
## File: CondoSphere.Infrastructure/Data/FinancialsDbContext.cs
```csharp
using CondoSphere.Core.Entities.Financials;
using Microsoft.EntityFrameworkCore;
...
@section Scripts {
    ...
    @{
        // Prepare C# boolean flags. This part is correct.
        ...
        var shouldOpenExpenseModal = TempData["OpenExpenseModal"] as bool? == true;
    }

    <script>
        document.addEventListener('DOMContentLoaded', function () {

            // --- 1. CONVERT C# FLAGS TO CLEAN JAVASCRIPT VARIABLES ---
            const openInterventionModal = @shouldOpenInterventionModal.ToString().ToLower();
            const openExpenseModal = @shouldOpenExpenseModal.ToString().ToLower();

            // --- 2. USE THE CLEAN JAVASCRIPT VARIABLES ---
...
```json
{
  ...
  "ConnectionStrings": {
    ...
    "FinancialsConnection": "Server=(LocalDb)\\MSSQLLocalDB;Database=CondoSphere_FinancialsDB;Trusted_Connection=True;"
  },
  "MailSettings": {
